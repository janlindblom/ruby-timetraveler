RSpec.describe TimeTraveler do
  ...
  it "can find the timezone for Åland, Finland" do
  ...
  it "can find the timezone for New Delhi, India" do
  ...
  it "can find the timezone for Palo Alto, USA" do
  ...
  it "can find the timezone for Cape Town, South Africa" do
